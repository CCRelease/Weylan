# ZipSolutionTool 1.2.0

Windows x64; instalación por usuario. La aplicación incluye .NET y permite cambiar entre EN, ES, CA, FR, DE, IT y PT.

## Instalación

Descarga [el instalador](ZipSolutionTool-1.2.0-win-x64-setup.exe), comprueba su SHA-256 según [SHA256SUMS.txt](SHA256SUMS.txt) y ejecútalo. Crea un acceso en el menú Inicio; el acceso de Escritorio es opcional. Para desinstalar, quita primero sus opciones del menú contextual desde la aplicación, ciérrala y usa **Aplicaciones instaladas** de Windows.

Para la edición portable, descarga [el ZIP](ZipSolutionTool-1.2.0-win-x64-portable.zip), comprueba el hash, extrae todo su contenido y ejecuta `ZipSolutionTool.exe`. Elimina la carpeta extraída para retirar esa edición. Si registraste opciones del Explorador, quítalas antes desde la propia app.
